#!/bin/bash
# readme: https://github.com/Stakers-space/staking-scripts/tree/main/teku/Beacon%20Log%20Monitor

service="tekubeacon.service"
tracking_definition_file="/usr/local/etc/teku_tracking_records.txt"
